<template>
    ...
    <div class="btn-group">
            <router-link :to="{ name : 'login'}" class="d-none d-sm-inline-block btn mx-2 btn-sm btn-primary shadow-sm"><i
                class="fas fa-home fa-sm text-white-50"></i> Home</router-link>
